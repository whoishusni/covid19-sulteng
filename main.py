...
def startCommand(update: Update,context: CallbackContext):
    update.message.reply_text('Start Command Executed !!!, BOT Now Running...')
    update.message.reply_text('Hai, Silahkan Pilih Menu BOT dibawah')
...
def main():
    ...
    updater.start_webhook(listen='0.0.0.0',port=80, url_path=API_KEY, webhook_url='https://covid19-sulteng.herokuapp.com/'+API_KEY)
    updater.idle()
